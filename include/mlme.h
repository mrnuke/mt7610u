...
typedef struct _RT_802_11_DLS {
	unsigned short						TimeOut;		/* Use to time out while slience, unit: second , set by UI */
	unsigned short						CountDownTimer;	/* Use to time out while slience,unit: second , used by driver only */
